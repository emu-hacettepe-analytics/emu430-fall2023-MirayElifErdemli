...
print(paste("Hour Duration:", hour_duration))
print(paste("Minute Duration:", minute_duration))
...
1.[Aşk Tesadüfleri Sever](https://m.imdb.com/title/tt1807950/)
2.[Kelebeliğin Rüyası](https://m.imdb.com/title/tt2608224/)
3.[İncir Reçeli](https://m.imdb.com/title/tt1808197/)
